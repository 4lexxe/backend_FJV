...
const Persona = sequelize.define(
  "Persona",
  {
    ...
    idClub: {
      type: DataTypes.INTEGER,
      allowNull: true, // O false, dependiendo de si una persona siempre debe pertenecer a un club
      references: {
        model: "clubs", // Nombre de la tabla a la que hace referencia
        key: "idClub", // Clave primaria de la tabla a la que hace referencia
      },
    },
    nombreApellido: {
    ...
    fechaLicenciaBaja: {
      ...
      allowNull: true,
      comment:
        "Fecha de vencimiento/baja de la licencia (sincronizada con credencial)",
    },
    estadoLicencia: {
      type: DataTypes.STRING(20),
      allowNull: true,
